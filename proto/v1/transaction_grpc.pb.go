...
const (
	TransactionService_CreateTransaction_FullMethodName   = "/packets.v1.TransactionService/CreateTransaction"
	TransactionService_GetTransaction_FullMethodName      = "/packets.v1.TransactionService/GetTransaction"
	TransactionService_CommitTransaction_FullMethodName   = "/packets.v1.TransactionService/CommitTransaction"
	TransactionService_RollbackTransaction_FullMethodName = "/packets.v1.TransactionService/RollbackTransaction"
	TransactionService_ListTransactions_FullMethodName    = "/packets.v1.TransactionService/ListTransactions"
)
...
type TransactionServiceClient interface {
	...
	CommitTransaction(ctx context.Context, in *CommitTransactionRequest, opts ...grpc.CallOption) (*TransactionResponse, error)
	RollbackTransaction(ctx context.Context, in *RollbackTransactionRequest, opts ...grpc.CallOption) (*TransactionResponse, error)
...
func (c *transactionServiceClient) CommitTransaction(ctx context.Context, in *CommitTransactionRequest, opts ...grpc.CallOption) (*TransactionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TransactionResponse)
...
func (c *transactionServiceClient) RollbackTransaction(ctx context.Context, in *RollbackTransactionRequest, opts ...grpc.CallOption) (*TransactionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TransactionResponse)
...
type TransactionServiceServer interface {
	...
	CommitTransaction(context.Context, *CommitTransactionRequest) (*TransactionResponse, error)
	RollbackTransaction(context.Context, *RollbackTransactionRequest) (*TransactionResponse, error)
...
func (UnimplementedTransactionServiceServer) CommitTransaction(context.Context, *CommitTransactionRequest) (*TransactionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CommitTransaction not implemented")
}
func (UnimplementedTransactionServiceServer) RollbackTransaction(context.Context, *RollbackTransactionRequest) (*TransactionResponse, error) {
...
var TransactionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "packets.v1.TransactionService",
	...
	Metadata: "proto/v1/transaction.proto",
}
